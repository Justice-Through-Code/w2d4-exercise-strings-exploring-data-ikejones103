...
# as a single string (make sure to add a space between each ingredient!)
    print(f"{ingredient_1} {ingredient_2} {ingredient_3} {ingredient_4}")
# String methods
# Save the f-string from 1.3 into a variable called `ingredients`
...
# 2.2 In a print statement, use one of the string methods to replace 'milk' with 'butter'
print(ingredients.replace('milk', 'butter'))
...
# Count the number of times 'milk' appears in the `ingredients` variable
...
# 2.7 Use another string method to print the string in the `ingredients` variable in all-caps now that it's right.
